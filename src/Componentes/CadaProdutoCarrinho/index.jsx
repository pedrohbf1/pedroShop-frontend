...
const CadaProdutoMeuCarrinho = ({ produto }) => {

    function deletarProduto () {
        axios.delete(`http://localhost:3000/meu-carrinho/${produto.idProduto}`)
        .then((r) => {
    ...
    return (
        <DetalhesContainer>
            ...
            <InformacoesProduto>
                ...
                <QuantidadeLabel htmlFor="quantidade">Quantidade : {produto.quantidade}</QuantidadeLabel>
                <Informacao style={{textAlign: "left"}}>
                    Valor total: {(parseFloat(produto.valorUnidade) * produto.quantidade).toFixed(2)}
                </Informacao>
...
export default CadaProdutoMeuCarrinho
