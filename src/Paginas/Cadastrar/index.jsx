...
const PaginaCadastrar = () => {
    const fullText = "Se você já possui uma conta";
    ...
    function cadastre () {
        if (nome == "" || email == "" || senha == "" || confirmarSenha == "") {
            ...
            if(senha == confirmarSenha) {
              ...
              axios.post("http://localhost:3000/registrar", objeto)
              .then(() => {
                navigate("/")
              })
              .catch((erro) => {
        ...
        <>
            ...
            <Container>
                <FormContainer>
                    ...
                    <Input type="text" placeholder="Confirmar senha" value={confirmarSenha} onChange={(e) => setConfirmarSenha(e.target.value)} />
                    <Button onClick={() => cadastre()} >Cadastrar</Button>
                ...
                <TextContainer>
                    ...
                    {showSignUp && <Link style={{textDecoration: "none"}} to="/" ><SignUpText>Entrar</SignUpText></Link>}
                </TextContainer>
                {error && <Modal title="Email já cadastrado" message="Esse email já está cadastrado no nosso sistema, tente novamente." estado={setError} />}
            </Container>
        </>
  );
};
